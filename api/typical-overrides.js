// Serverless API backing the Typical Month tab's per-account overrides.
// Stores one JSON object { [accountKey]: "removed" | "seasonal" } in Upstash
// Redis — same single-mutable-document pattern as /api/retirement.js.
//
// Requires KV_REST_API_URL / KV_REST_API_TOKEN env vars (Upstash for Redis,
// connected to this project via Vercel Storage).

const REDIS_KEY = "typical-month-overrides";
