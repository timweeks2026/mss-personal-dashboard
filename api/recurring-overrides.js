// Serverless API backing the Recurring Payments tab's per-cluster review
// state. Stores one JSON object { [clusterKey]: { status, category, notes } }
// in Upstash Redis — same single-mutable-document pattern as
// /api/typical-overrides.js.
//
// Requires KV_REST_API_URL / KV_REST_API_TOKEN env vars (Upstash for Redis,
// connected to this project via Vercel Storage).

const REDIS_KEY = "recurring-payments-overrides";
